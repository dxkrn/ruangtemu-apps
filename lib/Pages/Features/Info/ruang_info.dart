...
class RuangInformasi extends StatefulWidget {
  const RuangInformasi({super.key});

  @override
  State<RuangInformasi> createState() => _RuangInformasiState();
}

class _RuangInformasiState extends State<RuangInformasi> {
  ...
  void _firstLoad() async {
    ...
    final res = await httpClient.get(
        "$baseAPIUrl/news?type=INFORMATION&page=$_page&limit=$_limit&category=$selectedCategory&search=$search");
  ...
  void initState() {
    ...
    if (Get.arguments != null) {
      final args = Get.arguments as RuangInformasiArgs;
      setState(() {
    ...
    httpClient.get("$baseAPIUrl/info-categories").then((value) {
      var data = jsonDecode(value.body);
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FeatureAppbar(
          title: 'Ruang Informasi', iconSrc: 'assets/icons/icon_info.png'),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Image(
                      image: AssetImage('assets/images/img_ill_info.png'),
                    ),
                  ),
                  Container(
